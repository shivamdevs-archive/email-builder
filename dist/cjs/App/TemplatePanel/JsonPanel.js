...
function JsonPanel() {
    ...
    const code = (0, react_1.useMemo)(() => JSON.stringify(document, null, '  '), [document]);
    return react_1.default.createElement(HighlightedCodePanel_1.default, { type: "json", value: code });
}
exports.default = JsonPanel;
