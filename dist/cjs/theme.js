...
const BASE_THEME = (0, styles_1.createTheme)({
    palette: {
        background: {
            default: '#f2f5f7',
        },
...
const THEME = (0, styles_1.createTheme)(BASE_THEME, {
    palette: {
        brand: {
            navy: BRAND_NAVY,
            blue: BRAND_BLUE,
        ...
        success: {
            main: BRAND_GREEN,
            light: (0, styles_1.lighten)(BRAND_GREEN, 0.15),
            dark: (0, styles_1.darken)(BRAND_GREEN, 0.15),
        },
        error: {
            main: BRAND_RED,
            light: (0, styles_1.lighten)(BRAND_RED, 0.15),
            dark: (0, styles_1.darken)(BRAND_RED, 0.15),
        },
        cadet: {
            100: '#F9FAFB',
            200: '#F2F5F7',
        ...
        highlight: {
            100: (0, styles_1.lighten)(BRAND_YELLOW, 0.8),
            200: (0, styles_1.lighten)(BRAND_YELLOW, 0.6),
            300: (0, styles_1.lighten)(BRAND_YELLOW, 0.4),
            400: (0, styles_1.lighten)(BRAND_YELLOW, 0.2),
            500: BRAND_YELLOW,
        },
        info: {
            main: BRAND_BLUE,
    ...
    components: {
      ...
      `,
        ...
        MuiTableCell: {
            styleOverrides: {
                root: Object.assign(Object.assign({}, BASE_THEME.typography.body2), { borderColor: BASE_THEME.palette.grey[200] }),
                head: Object.assign(Object.assign({}, BASE_THEME.typography.overline), { fontWeight: BASE_THEME.typography.fontWeightMedium, letterSpacing: '0.075em', color: BASE_THEME.palette.text.secondary }),
            },
        },
        MuiTableRow: {
            styleOverrides: {
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    ...
                    backgroundColor: (0, styles_1.alpha)(BASE_THEME.palette.text.primary, 0.9),
                },
            },
        },
        MuiSlider: {
            styleOverrides: {
                ...
                thumb: {
                    ...
                    '&:hover, &.Mui-active, &.Mui-focusVisible': {
                        boxShadow: `0 0 0 4px ${(0, styles_1.alpha)(BRAND_BLUE, 0.2)}`,
                    },
                    '&:before': {
                        display: 'none',
                    },
