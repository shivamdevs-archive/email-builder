...
export default function InspectorDrawer({ articles }) {
    ...
    const renderCurrentSidebarPanel = () => {
        switch (selectedSidebarTab) {
            ...
            case "articles":
                return React.createElement(ArticlesPanel, { articles: articles });
            default:
        ...
        React.createElement(Box, { sx: {
            ...
            React.createElement(Box, { px: 2 },
                React.createElement(Tabs, { value: selectedSidebarTab, onChange: (_, v) => setSidebarTab(v) },
                    ...
                    React.createElement(Tab, { value: "articles", label: "Articles" })))),
        React.createElement(Box, { sx: {
                width: INSPECTOR_DRAWER_WIDTH,
