...
import { Box, Card, CardContent, CardMedia, Dialog, DialogContent, DialogTitle, Typography, } from "@mui/material";
export default function ImportArticleDialog({ onClose, articles, }) {
    return (React.createElement(Dialog, { open: true, onClose: () => onClose() },
        React.createElement(DialogTitle, null, "Select Article"),
        React.createElement(DialogContent, null,
            React.createElement(Box, { display: "grid", gap: 2, gridTemplateColumns: "repeat(2, minmax(40%, 1fr))", padding: 2 }, articles.map((article, index) => (React.createElement(Card, { key: index, onClick: () => onClose(article), sx: {
                    "cursor": "pointer",
                    "padding": 2,
                    "border": 1,
                    "borderColor": "divider",
